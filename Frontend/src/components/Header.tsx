        ...
        <header className="bg-blue-400 p-4 md:p-6">
            ...
            <nav className="flex justify-center">
                <ul className="flex justify-center space-x-2 md:space-x-4 lg:space-x-8 text-white md:flex-nowrap">
                    <li className="flex-grow text-xs md:text-base lg:text-lg"><Link to="/">Вакансии</Link></li>
                    <li className="flex-grow text-xs md:text-base lg:text-lg"><Link to="/responses">Отклики на
                        вакансии</Link></li>
                    {role === 'Student' &&
                        <li className="flex-grow text-xs md:text-base lg:text-lg"><Link to="/calendar">Календарь
                            собеседований</Link></li>}
                    <li className="flex-grow text-xs md:text-base lg:text-lg"><Link to={PROFILE_ROUTE}>Настройка
                        профиля</Link></li>
                    {role === 'Admin' &&
